...
class NetworkTopo(Topo):
    def build(self, **_opts):
        ...
        self.addLink(s5, router1, intfName2='r1-eth1', params2={'ip': '192.168.3.1/29'})
        self.addLink(s5, router2, intfName2='r2-eth1', params2={'ip': '192.168.3.2/29'})
        self.addLink(s5, router3, intfName2='r3-eth1', params2={'ip': '192.168.3.3/29'})
        self.addLink(s5, router4, intfName2='r4-eth1', params2={'ip': '192.168.3.3/29'})
        self.addLink(s1, router1, intfName2='r1-eth0', params2={'ip': '192.168.1.1/24'})
        self.addLink(s2, router2, intfName2='r2-eth0', params2={'ip': '192.168.1.2/24'})
        self.addLink(s3, router3, intfName2='r3-eth0', params2={'ip': '192.168.1.3/24'})
        self.addLink(s4, router4, intfName2='r4-eth0', params2={'ip': '192.168.1.4/24'})
        ...
        h3 = self.addHost('h3', ip='192.168.1.102/24', defaultRoute='via 192.168.1.1')
        h4 = self.addHost('h4', ip='192.168.1.103/24', defaultRoute='via 192.168.1.1')
